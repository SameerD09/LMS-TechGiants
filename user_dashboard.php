...
<div class="user-app-wrapper">
  ...
  <div class="user-sidebar">
    ...
    <div class="user-sidebar-bottom">
      <!-- Balance display -->
      <div class="u-balance-pill">
        <span class="u-balance-label">💰 Balance</span>
        <span class="u-balance-amount" id="uSidebarBalance">Rs —</span>
      </div>
...
<div class="modal-overlay" id="uBorrowModal">
  <div class="modal">
    ...
    <div id="uBorrowFeeInfo" style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:10px 16px;margin-bottom:14px;"></div>
    ...
    <div class="form-group">
      <label>Borrow Duration <span style="color:#e53e3e;">*</span> <span style="font-weight:400;color:#888;">(max 7 days · Rs 100/day)</span></label>
      <select id="uBorrowDaysSelect" style="width:100%;padding:10px 14px;border-radius:10px;border:1.5px solid var(--border);background:var(--surface);color:var(--text-primary);font-family:var(--font-body);font-size:0.9rem;cursor:pointer;appearance:auto;">
        ...
        <option value="1">1 day — Rs 100</option>
        <option value="2">2 days — Rs 200</option>
        <option value="3">3 days — Rs 300</option>
        <option value="4">4 days — Rs 400</option>
        <option value="5">5 days — Rs 500</option>
        <option value="6">6 days — Rs 600</option>
        <option value="7">7 days — Rs 700</option>
      </select>
...
<div class="modal-overlay" id="uPdfPurchaseModal">
  <div class="modal modal-sm">
    ...
    <p style="color:var(--text-secondary);font-size:0.95rem;margin:8px 0 16px;">
      <strong id="uPdfBookTitle"></strong><br>
      This is a permanent digital download.
    </p>
    <div style="background:var(--bg-subtle,#f8f8f6);border-radius:10px;padding:14px 18px;margin-bottom:14px;font-size:0.93rem;">
      ...
      <div style="display:flex;justify-content:space-between;">
        ...
        <strong id="uPdfBalance" style="color:var(--accent);"></strong>
      </div>
    </div>
    <div id="uPdfAffordWarn" style="color:#e53e3e;font-size:0.87rem;margin-bottom:10px;display:none;">⚠️ Insufficient balance to purchase this book.</div>
    <div class="modal-actions">
      <button class="btn-primary" id="uPdfConfirmBtn" onclick="confirmPdfPurchase()">Buy & Download</button>
...
<div class="modal-overlay" id="uFineBreakdownModal">
  <div class="modal modal-sm">
    ...
    <p style="color:var(--text-secondary);font-size:0.9rem;margin:6px 0 14px;">The following amounts have been deducted from your wallet.</p>
