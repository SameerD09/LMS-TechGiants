...
// ── DOWNLOAD — triggers direct PDF file download ──
function downloadBook() {
  ...
  // Create a hidden anchor and click it — triggers instant file download
...
function submitExtend() {
  ...
  .then(function(data) {
    if (data.success) {
      ...
      sucEl.textContent = '✅ Extended! Your new due date is ' + newDueFmt + '.';
      ...
      document.getElementById('uExtendSubmitBtn').style.opacity = '0.5';
      renderReadingList();
      setTimeout(function() { closeModal('uExtendModal'); }, 2000);
      showToast('✅ Borrow extended to ' + newDueFmt + '!');
    } else {
